...
import mapreduce.execution.task.scheduling.taskresultcomparisonscheduling.sortingcomparators.MinAssignedWorkerTaskResultSortingComparator;
...
public class MinAssignedWorkersTaskResultComparisonScheduler extends AbstractTaskResultComparisonScheduler {
	...
	public MinAssignedWorkersTaskResultComparisonScheduler randomizeFirstTask(boolean randomizeFirstTask) {
