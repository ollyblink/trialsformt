...
public class TaskTest {
	...
	public void testUpdateExecutingPeerStatus() {
		PeerAddress peerAddress = new PeerAddress(new Number160(1));
		...
		PeerAddress peerAddress2 = new PeerAddress(new Number160(2));
		...
		PeerAddress peerAddress3 = new PeerAddress(new Number160(3));
