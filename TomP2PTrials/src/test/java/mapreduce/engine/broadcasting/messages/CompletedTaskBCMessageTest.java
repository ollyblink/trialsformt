...
//				.createCompletedTaskBCMessage(ExecutorTaskDomain.create(null, null, 0, JobProcedureDomain.create(null,0, null, null, 0)), null));
//		bcMessages.add(CompletedBCMessage.createCompletedProcedureBCMessage(JobProcedureDomain.create(null,9, null, null, 0), null));
//		bcMessages.add(CompletedBCMessage
//				.createCompletedTaskBCMessage(ExecutorTaskDomain.create(null, null, 0, JobProcedureDomain.create(null,9, null, null, 1)), null));
//		bcMessages.add(CompletedBCMessage.createCompletedProcedureBCMessage(JobProcedureDomain.create(null,9, null, null, 1), null));
//		bcMessages.add(CompletedBCMessage
//				.createCompletedTaskBCMessage(ExecutorTaskDomain.create(null, null, 0, JobProcedureDomain.create(null,9, null, null, 2)), null));
//		bcMessages.add(CompletedBCMessage
//				.createCompletedTaskBCMessage(ExecutorTaskDomain.create(null, null, 0, JobProcedureDomain.create(null,9, null, null, 0)), null));
//		bcMessages.add(CompletedBCMessage
//				.createCompletedTaskBCMessage(ExecutorTaskDomain.create(null, null, 0, JobProcedureDomain.create(null,9, null, null, 1)), null));
//		bcMessages.add(CompletedBCMessage.createCompletedProcedureBCMessage(JobProcedureDomain.create(null,9, null, null, 0), null));
//		int counter = 0;
