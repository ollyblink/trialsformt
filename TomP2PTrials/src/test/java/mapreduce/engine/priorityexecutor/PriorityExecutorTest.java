...
public class PriorityExecutorTest {
	...
	public void testTaskSubmission() {
		// ===========================================================================================================================================
		// This test should show if cancellation of Futures works (see JobCalculationMessageConsumer for the
		// actual methods that cancel procedures and
		// tasks and JobCalculationMessageConsumerTest for the tests of the corresponding methods). This is a
		...
		// ===========================================================================================================================================
		// The test expects that only the first task is executed and, as execution takes 10 seconds, other
		// tasks in the queue are aborted and,
		// therefore, not executed anymore if they correspond to the specified procedure or task. Each task
		// should occur once in the queue because
		// it needs 1 result hashs to be completed
		// ===========================================================================================================================================
		// Test task abortion
		while (!tasks.isEmpty()) {
